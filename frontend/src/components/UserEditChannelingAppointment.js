...
const UserEditChannelingAppointment = (
    {
        onClose,
        channelingAppointmentData,
        fetchData
    }
) => { 
    ...
    const [data,setData] = useState({
        ...channelingAppointmentData,
        doctorName : channelingAppointmentData?.doctorName,
        date : channelingAppointmentData?.date,
        patientName : channelingAppointmentData?.patientName,
        contactNo : channelingAppointmentData?.contactNo,
        email : channelingAppointmentData?.email,
        otherNotes : channelingAppointmentData?.otherNotes
      ...
      const handleSubmit = async(e) =>{
        ...
        const response = await fetch(SummaryApi.updateChannelingAppointment.url,{
          method : SummaryApi.updateChannelingAppointment.method,
          credentials : 'include',
          headers : {
...
export default UserEditChannelingAppointment
