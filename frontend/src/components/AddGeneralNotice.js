...
const AddGeneralNotice = ({
  ...
  return (
    <div className='fixed w-full h-full bg-slate-200 bg-opacity-60 bottom-0 top-0 right-0 left-0 flex justify-center items-center'>
        <div className='bg-white p-4 rounded-xl w-full max-w-2xl max-h-[90%]'>
            <div className='flex justify-between items-center font-bold'>
                <h2>New General Notice</h2>
            ...
            <form className='grid p-6 gap-2 h-full pb-5 overflow-y-scroll ' onSubmit={handleSubmit}>
                ...
                <button className='px-3 py-1 bg-green-600 hover:bg-green-700 text-white rounded-full' >Create</button>
